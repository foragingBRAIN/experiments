...
function R = foraging_schedule_header(E,platform)
    ...
    R.fileName = sprintf('%s/data/foraging_schedule_%s_%i-%i-%i_%i-%i-%i', cd, subjectName, time(3), time(2), time(1), time(4), time(5), round(time(6)));
