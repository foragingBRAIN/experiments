...
function foraging_twobuttons_messages(W,E,bb)
    ...
    if bb>0
        ...
        if (bb==1)
            ...
            txt1 = 'Click on the button';
            txt2 = 'to get a reward';
        ...
        txt2 = sprintf('Reward=%i / Cost=%i', E.stimReward, E.stimCost(E.costList(bb)));
        bnd1 = Screen('TextBounds', W.n, txt1);
        bnd2 = Screen('TextBounds', W.n, txt2);
